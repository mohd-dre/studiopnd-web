        ...
        <Lens>
          ...
          <Scroll html>
            <div style={{ transform: 'translate3d(65vw, 192vh, 0)' }}>
              <a href="https://www.instagram.com/studiopanda_gfx/">Contact Us</a>
            </div>
          </Scroll>
...
function Typography() {
  ...
  return (
    <>
      <Text children="Welcome" anchorX="left" position={[-width / 2.5, -height / 10, 12]} {...shared} />
      <Text children="3D" anchorX="right" position={[width / 2.5, -height * 2, 12]} {...shared} />
      <Text children="Art" position={[0, -height * 4.624, 12]} {...shared} />
    </>
  )
}
